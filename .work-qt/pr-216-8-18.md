...
- [x] `python verify/qldpc_verify.py codes/216-8-18.json` passes locally
...
Score kd^2/n = 12.0, max check weight 9, locality class unrestricted.
...
Research note: `notes/216-8-18.md`

---
This is a reproduction of a published quantum Tanner code from arXiv:2512.20532 (Table 1b); `provenance.novelty` is set to `known_parameters`. The distance is a witness-backed upper bound (the paper reports a QDistRnd upper bound of d<=18).
