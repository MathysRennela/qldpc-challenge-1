...
Tool-agnostic instructions for an LLM (or any agent) doing autoresearch on the qLDPC
challenge. Point your model at this file. Claude Code exposes it as the `/autoresearch`
skill, but nothing here is Claude-specific.
