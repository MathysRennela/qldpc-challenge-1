...
\author{William J. Zeng, Farrokh Labib, Bradley A. Chase, Mathys Rennela,\\
  Ben Castanon, and Vincent Russo\\[4pt]
  Unitary Foundation\\
...
$[[144,12,12]]$ of Bravyi et al.~\cite{bravyi2024high} to planar open-boundary
...
\midrule
Rotated surface (Kitaev)~\cite{kitaev2003fault}      & $[[d^2,1,d]]$   & planar       & 4  & $1$\\
Gross code (Bravyi et al.)~\cite{bravyi2024high}     & $[[144,12,12]]$ & periodic     & 6  & $12$\\
Tile code (Steffan et al.)~\cite{steffan2025tile}    & $[[512,18,19]]$ & planar       & 8  & $12.7$\\
Panteleev--Kalachev (GB)~\cite{panteleev2021degenerate} & $[[126,28,8]]$  & periodic  & 10 & $14.2$\\
Coset 2BGA (Aydin et al.)~\cite{aydin2026breaking}   & $[[168,20,14]]$ & unrestricted & 8  & $23.3$\\
\bottomrule
\end{tabular}
...
planar codes of Liang, Eberhardt, and Chen~\cite{liang2025planar}; the
bivariate-bicycle codes of Bravyi et al.~\cite{bravyi2024high}; the
generalized-bicycle codes of Panteleev--Kalachev~\cite{panteleev2021degenerate}
and Wang--Pryadko~\cite{wang2022distance}; the coset two-block codes of Aydin,
Tamo, and Barg~\cite{aydin2026breaking}; and the Kitaev~\cite{kitaev2003fault}
and Steane~\cite{steane1996error} baselines), so a submission is always measured
