# [[176,22,4]] — weight-4 multivariate-bicycle finalist
...
The submitted code has n=176, k=22, and maximum check weight 4. The repository witness search found X and Z logicals of weight 4, so the submitted distance is the upper bound d<=4, not an exact certification. The trusted validator passed the CSS, witness, deduplication, and refutation gates and marked the unrestricted × weight-4 cell as board-advancing.
...
Use the bivariate-bicycle construction on Z_11 × Z_8 with A={(0,0),(0,5)} and B={(0,0),(0,7)}. Build H_X=[A|B] and H_Z=[B^T|A^T] over GF(2).
