...
Submitted [[12,2,3]]: witness d_X ≤ 3 and d_Z ≤ 3 found by `qldpc submit`
...
**upper bound**, not exact. Companion [[14,2,3]] from the same generator is
...
Parameters: n=12, 5 rows per side, max row weight 4, detect-all weight-≤2
