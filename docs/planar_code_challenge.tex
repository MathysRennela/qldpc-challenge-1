...
\begin{document}
	...
	\begin{abstract}
		The qLDPC Challenge is a public leaderboard for quantum low-density
	...
	Reference points the boards are seeded with (all $q=2$; $w$ = max check
	weight):
	\begin{center}
		\begin{tabular}{lcccc}
			\toprule
	...
	with a best $\eff\approx 14.2$ (a $[[126,28,8]]$ weight-8 entry); the live
	...
	\begin{itemize}[nosep]
		...
		arXiv:2203.17216 --- distance bounds for generalized bicycle codes
		(generalized-bicycle-track seed).
